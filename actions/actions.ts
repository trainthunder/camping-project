...
export const createProfileAction = async (
  ...
  try {
    ...
    const validateField = validateWithZode(profileSchema, rawData);
...
export const createLandmarkAction = async (
  ...
  try {
    ...
    const validatedFile = validateWithZode(imageSchema, { image: file });
    const validateField = validateWithZode(landmarkSchema, rawData);
